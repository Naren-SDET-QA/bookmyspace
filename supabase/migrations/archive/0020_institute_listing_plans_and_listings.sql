...
--
-- This filename collided with 0020_booking_hold_reconciliation.sql.  The
-- institute listing migration is retained in the later 0021 migration file,
-- which owns these objects exactly once in the replay order.
-- ============================================================
